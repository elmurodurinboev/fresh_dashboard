...
const Index = () => {
  ...
  const usersData = useQuery({
    queryKey: ['getAllUsers', page, page_size, search, role],
          ...
          <div>
            <Popover>
              <PopoverTrigger asChild>
                <Button variant={role ? "" : "outline"} size={"icon"}>
                  <IconFilter size={18}/>
                </Button>
              </PopoverTrigger>
              <PopoverContent className="w-72" align={"end"}>
                <div className={"flex flex-col gap-1"}>
                  <span className={"text-sm font-medium text-gray-400"}>Rolni tanlang</span>
                  ...
                  <div className={"flex justify-end"}>
                    <Button variant={"destructive"} onClick={() => setRole("")}>Tozalash</Button>
                  </div>
                </div>
              </PopoverContent>
            </Popover>
                      ...
                      <div>
                        <Select value={page_size}
                          ...
                          <SelectContent>
                            ...
                            {
                              usersData?.data?.count > 10 && <SelectItem value={"20"}>20</SelectItem>
                            }
                            {
                              usersData?.data?.count > 20 && <SelectItem value={"30"}>30</SelectItem>
                            }
                            {
                              usersData?.data?.count > 30 && <SelectItem value={"40"}>40</SelectItem>
                            }
                            {
                              usersData?.data?.count > 40 && <SelectItem value={"50"}>50</SelectItem>
                            }
                          </SelectContent>
                        </Select>
                      </div>
