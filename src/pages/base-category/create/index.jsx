...
const formSchema = z.object({
  name: z
    .string()
    .min(3, {message: "Nom bo'lishi va kamida 3 harfdan iborat bo'lishi shart"}),
  image: z
    .any()
})
...
const Index = () => {
  ...
  const mutation = useMutation({
    mutationFn: BaseCategoryService.create,
    onError: (error) => {
    ...
    <Layout>
      ...
      <Layout.Body>
        <div className="mb-2 flex flex-col gap-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Umumiy kategoriya yaratish</h2>
          </div>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className={"grid grid-cols-12 gap-4"}>
              ...
              <div className={"col-span-12 lg:col-span-4 flex flex-col gap-3"}>
                ...
                <Button
                  ...
                  type={"reset"}
                  variant={"outline"}
                  onClick={() => navigate("/base-category")}
