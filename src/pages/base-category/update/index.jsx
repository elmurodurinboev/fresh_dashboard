...
const Index = () => {
  ...
  const categoryData = useQuery({
    ...
    queryFn: BaseCategoryService.getOne,
  ...
  const mutation = useMutation({
    mutationFn: BaseCategoryService.updatePatch,
    onError: (error) => {
    ...
    <Layout>
      <Layout.Body>
        <div className="mb-2 flex flex-col gap-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Umumiy kategoriyani o`zgartirish</h2>
          </div>
          <Form {...form}>
